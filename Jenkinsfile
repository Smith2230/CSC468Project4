        ...
        stage ('Deploy') {
            ...
            steps {
                sshagent(credentials: ['cloudlab']) {
                    ...
                    sh 'ssh -o StrictHostKeyChecking=no zs947869@pcvm709-1.emulab.net kubectl apply -f /users/zs947869/worker.yaml -n centigro'
                    sh 'ssh -o StrictHostKeyChecking=no zs947869@pcvm709-1.emulab.net kubectl apply -f /users/zs947869/worker-service.yaml -n centigro'                    
                }
            }
        }
    }
